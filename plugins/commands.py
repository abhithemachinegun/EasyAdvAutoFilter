...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)   
        m=await message.reply_sticker("CAACAgIAAxkBAAIG_mU9IO9b8CSMEQON2CnDdQVK_ybFAAKpFgACc_QAAUtyCXMIz-lEyh4E") 
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "↺ ᴊᴏɪɴ ʙᴀᴄᴋ-ᴜᴘ ᴄʜᴀɴɴᴇʟ ↺", url=invite_link.invite_link
                )
            ]
        ]
        ...
        await client.send_photo(
            photo = "https://graph.org/file/d4843543964a7d6b05276.jpg",
